...
- `Certificates/C++ and Programming/2021 C++ Essential Training (2018) (1).pdf` and `(2).pdf`, `2021 Learning C++ Pointers (1).pdf` and `(2).pdf`, `2021 Nail Your C++ Interview.pdf`, `2021 Introducing Functional Programming in C++.pdf`: LinkedIn Learning courses completed during this period. The `(1)` and `(2)` files are two certificate layouts for the same completed course.
