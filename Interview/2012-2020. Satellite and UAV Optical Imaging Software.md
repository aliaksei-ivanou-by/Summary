...
| Role | Design engineer and research engineer in the research department of the Space Research and Design Division |
...
The one item worth naming is the **International Summer Space School at Samara State Aerospace University, August 2013** - "Advanced technologies for nanosatellite's experiments in space", 3.5 ECTS. It was my second session - the first was in August 2011, during the degree - and this one was attended a year into the job, on the same broad subject I was now working on professionally. It carries ECTS credit, which makes it the only academic credit earned during this period.

The second page of the certificate records a syllabus distinct from the 2011 school. Lectures covered space-systems engineering and standards, flight dynamics and attitude control, GNSS fundamentals and hardware, and micro/nanosatellite mission and system requirements, functional architecture, operational modes, link budget, power budget and advanced space technologies. A design-technology lecture used Pro/ENGINEER. Laboratories covered micro/nanosatellite design in Pro/ENGINEER, development of mission and system requirements, link- and power-budget computation, and a practical NOAA satellite reception exercise. The teaching was in English with an international intake.

The rest of the training in these years was applied rather than academic, and each piece has a project behind it: the 108-academic-hour Java programme at IT-Academy (26 October - 21 December 2013), Ruby on Rails (February - June 2015) immediately before building the satellite reference database on Rails and PostgreSQL, LaTeX (2016) for design documentation, English at Streamline from A1 to B2 (2015-2017), and the 108-academic-hour classroom C++ course at the High-Tech Park educational centre in 2018 - the last of them, taken while still at PELENG and eighteen months before the move into commercial C++. Full detail in `Certificates and Continuing Education.md`.
...
- **My contribution:** wrote the two-page analytical text "Integrated Space Monitoring Systems as an Evolution of Geographic Information Systems" (RU), signed in my professional capacity as **Aliaksei Ivanou, Design Engineer, Space Research and Design Division, PELENG JSC**.
...
- **Status:** the signed text is archived in this repository.
...
- **Result:** better image quality at the same compression ratio on the reference imagery; no separate matched-computational-cost claim is made.
...
| International Summer Space School, Samara, August 2013, 3.5 ECTS | English-language training in systems engineering, flight dynamics, GNSS, requirements, architecture, link/power budgets, Pro/ENGINEER and NOAA reception, a year into the role | `Certificates/2012-2020. Satellite and UAV Optical Imaging Software/2013 Advanced technologies for nanosatellite's experiments in space - 2013.pdf` |

### Resume-Ready Bullets

- Designed and implemented image-processing algorithms in MATLAB for the optoelectronic imaging payloads of Earth remote-sensing satellites and a UAV optical system across more than seven years in the research department of the Space Research and Design Division at an optoelectronic instrument manufacturer.
...
- Authored a two-page analytical text on integrated space monitoring as an evolution of geographic information systems, covering Earth remote sensing combined with GLONASS/GPS positioning and the operational implications of small-satellite constellations.
...
- **Outside this document** - in the career index, the recruiter brief, the spoken material and the CV - the same work is described as an *airborne optical imaging system*, and the satellite programs are not named. This is the same rule that keeps customers unnamed outside their project documents: the full picture lives in one place, and the summaries carry the category rather than the specifics. The file and folder names still read "UAV" and are the one remaining exception.

### The Enterprise's Sanctions Designations

This is public, a recruiter or a compliance screen will find it, and it is better known before an interview than discovered during one.

PELENG was first designated by the United States and Canada on 2 December 2021. The United Kingdom listed it on 8 August 2023, and the European Union on 23 February 2024; other jurisdictions followed. The published grounds are not identical in every jurisdiction. The US designation cites operation in the Belarusian defense, related-materiel and security sectors; the UK cites support for the Government of Belarus through the defense sector; and the EU cites components for Russian artillery systems and military vehicles used in the war against Ukraine. None of those grounds concerns the civil Earth-observation work described in this document.

| Established | Not established |
|---|---|
| I worked there from August 2012 to January 2020, in the research department of the Space Research and Design Division | Anything about the enterprise's defense-related production, which sat outside my department and outside my role |
| No designation existed against the enterprise at any point during my employment; the first confirmed designations came on 2 December 2021, nearly two years after I left | Whether any part of the imaging work I did was later applied elsewhere in the enterprise |
| I left in January 2020 - before the August 2020 political crisis, nearly two years before the first designation, and more than two years before February 2022 | |
| My work was civil Earth remote sensing and an airborne optical imaging system: algorithms, calibration, and validation against test data | |
| The satellite programs named in this document - BKA, Kanopus-V, EgyptSat - are civil Earth-observation programs documented in open sources | |

**The answer if it is raised.** I was an image-processing R&D engineer in the civil Earth-observation part of the enterprise until January 2020, and I have had no relationship with it since. The first designations came nearly two years after I left and rest on enterprise activity that was neither mine nor my department's. If a role carries export-control or clearance obligations, I would disclose the history and let the employer's compliance function assess it.

**What not to do with it.** Do not volunteer this in a screening call where nobody asked; it answers a question that has not been put, and it moves the conversation away from the engineering. Do answer it directly and without hedging the moment it is asked, including in a compliance questionnaire.

**Do not build an argument out of international cooperation.** The tempting move is to answer the sanctions question by pointing at the international side of the work. It backfires. The international dimension of the enterprise's civil space work in this period runs almost entirely through Russian programs and a Russian prime contractor, and my own one international credential from the period is a summer school in Samara run with support from the Tsiolkovsky Russian Academy of Cosmonautics. Raised in a European hiring conversation, that turns a neutral fact - worked at a Belarusian optics manufacturer until 2020 - into a Russian aerospace association, which is the opposite of the intended effect. The dates carry the answer on their own and need no help. The Samara schools stay in `Certificates and Continuing Education.md` as what they are, academic credit; they are not promoted into any summary as evidence of international exposure.

**The evidence that I work in a Western engineering environment is recent and sits elsewhere** - English as the working language across distributed teams in the United States, India and Europe at EPAM and Innowise, and two years employed in Warsaw on a Polish work permit. That belongs in the answer about how I work, not in the answer about PELENG.

**This is not a legal opinion, and I do not offer one.** An entity designation is a measure against the entity: asset freezes and transaction prohibitions. It does not in itself restrict employing someone who used to work there. Roles carrying export-control or security-clearance obligations are governed by the employer's own policy, which can be stricter than the law requires. State the facts and the dates and let the employer's compliance function reach its own conclusion.
...
- `SelfIntro.md`: PELENG as the first long-term role, the period as a design and research engineer, MATLAB and internal data-processing tools, and the algorithm set framed as the foundation before commercial C/C++ development.
- `Certificates/2012-2020. Satellite and UAV Optical Imaging Software/2013 Advanced technologies for nanosatellite's experiments in space - 2013.pdf`: International Summer Space School at Samara State Aerospace University, August 2013, 3.5 ECTS, attended a year into the role; page 2 contains the complete lecture and laboratory syllabus. The first session, August 2011, belongs to the degree period and its certificate sits in `Certificates/2007-2012. Radiophysics Degree and University Research/`.
- `Articles/2012-2020. Satellite and UAV Optical Imaging Software/2012-2020 Integrated Space Monitoring Systems as an Evolution of GIS (conference talk, RU).pdf`: **my own article**, written during this period.
...
- US Treasury, designation of PELENG on 2 December 2021 and published grounds: [Treasury Expands Sanctions Against Belarusian Regime with Partners and Allies](https://home.treasury.gov/news/press-releases/jy0512)
- Government of Canada, consolidated sanctions list recording PELENG's listing on 2 December 2021: [Consolidated Canadian Autonomous Sanctions List](https://www.international.gc.ca/world-monde/assets/pdfs/international_relations-relations_internationales/sanctions/sema-lmes.pdf)
- UK Sanctions List, PELENG designated 8 August 2023: [JSC PELENG, BEL0137](https://search-uk-sanctions-list.service.gov.uk/designations/BEL0137/Entity)
- European Union, PELENG listed 23 February 2024 with statement of reasons: [Council Decision (CFSP) 2024/747](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024D0747)
...
| Authored "Integrated Space Monitoring Systems as an Evolution of Geographic Information Systems" (RU) | `Articles/2012-2020. Satellite and UAV Optical Imaging Software/2012-2020 Integrated Space Monitoring Systems as an Evolution of GIS (conference talk, RU).pdf`, signed and with matching PDF author metadata | Public |
...
| Sanctions designations of the enterprise, beginning with the US and Canada on 2 December 2021 | Official US, Canadian, UK and EU listings linked above | Public; position set out in section 12 |
