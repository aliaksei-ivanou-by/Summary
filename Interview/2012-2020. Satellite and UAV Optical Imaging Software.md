...
| Delivery company / customer | PELENG, an open joint-stock company (ОАО «Пеленг»), Minsk - product and design organization; payloads delivered to satellite prime contractors and national space programs |
| Role | Design engineer and research engineer in the research department of the Space Research and Design Division (Научно-конструкторское управление «Космос», НКУ «Космос»); the entire period in one unit |
...
I worked the entire period in one unit: the research department of the Space Research and Design Division - in Russian, Научно-конструкторское управление «Космос», abbreviated НКУ «Космос».

That second level matters. A design division at an enterprise like this covers the full path from research to serial design documentation and production support; the research department is the end of it where feasibility, algorithms and methods are worked out, before anything becomes a released design. It is the structural reason my years there were algorithm and R&D work rather than drawing-office work, and it is worth saying in an interview when someone hears "инженер-конструктор" and pictures serial design.
...
- **My contribution:** wrote and published an analytical article, "Integrated Space Monitoring Systems as an Evolution of Geographic Information Systems" («Системы комплексного космического мониторинга как развитие геоинформационных систем»), signed in my professional capacity: **Алексей Иванов, инженер-конструктор, НКУ «Космос», ОАО «Пеленг»**.
...
- `Articles/2012-2020. Satellite and UAV Optical Imaging Software/2012-2020 Integrated Space Monitoring Systems as an Evolution of GIS (conference talk, RU).pdf`: **my own article**, written during this period and signed «Алексей Иванов, Инженер-конструктор, НКУ "Космос" ОАО "Пеленг"». PDF metadata gives the author as Иванов Алексей Леонидович. This is the one source in the repository that confirms the job title and the unit independently of any CV.
- Current project account: the entire period spent in one unit - the research department (исследовательский отдел) of Научно-конструкторское управление «Космос», the Space Research and Design Division.
...
| Position: design engineer and research engineer (инженер-конструктор), research department of the Space Research and Design Division | First-hand record, **and the signature on my own article** | Public |
