...
Questions are numbered in topic order. Every answer begins with a short bullet summary and keeps details, examples and edge cases below it.

## Language Fundamentals and Modern C++

|  |  |  |
|---|---|---|
| [CPP-001. What should you know about fundamental types, `nullptr` and `std::byte`?](#question-cpp-001) | [CPP-002. What are integer promotions and usual arithmetic conversions?](#question-cpp-002) | [CPP-003. What goes wrong when signed and unsigned meet in a comparison or a loop?](#question-cpp-003) |
| [CPP-004. `enum` vs `enum class`?](#question-cpp-004) | [CPP-005. How does `const` work with pointers and member functions?](#question-cpp-005) | [CPP-006. What does `const` on a member function actually guarantee?](#question-cpp-006) |
| [CPP-007. When should each C++ cast be used?](#question-cpp-007) | [CPP-008. What initialization forms exist, and why use braces carefully?](#question-cpp-008) | [CPP-009. What is `explicit` used for?](#question-cpp-009) |
| [CPP-010. What do `= default` and `= delete` mean?](#question-cpp-010) | [CPP-011. What is the difference between `auto` and `decltype(auto)`?](#question-cpp-011) | [CPP-012. What is `decltype`?](#question-cpp-012) |
| [CPP-013. What is the difference between lvalue and rvalue?](#question-cpp-013) | [CPP-014. What are prvalue, xvalue and glvalue?](#question-cpp-014) | [CPP-015. Why can `const T&` bind to a temporary?](#question-cpp-015) |
| [CPP-016. When does lifetime extension not work?](#question-cpp-016) | [CPP-017. What does `std::move` actually do?](#question-cpp-017) | [CPP-018. What is a forwarding reference?](#question-cpp-018) |
| [CPP-019. What is `std::forward` used for?](#question-cpp-019) | [CPP-020. Why should move constructors often be `noexcept`?](#question-cpp-020) | [CPP-021. When does the compiler generate a move constructor?](#question-cpp-021) |
| [CPP-022. What is copy elision?](#question-cpp-022) | [CPP-023. In what order are function arguments evaluated, and why did that leak before C++17?](#question-cpp-023) | [CPP-024. What is undefined behavior?](#question-cpp-024) |
| [CPP-025. Undefined vs unspecified vs implementation-defined behavior?](#question-cpp-025) | [CPP-026. What is the as-if rule?](#question-cpp-026) | [CPP-027. What is `volatile` for?](#question-cpp-027) |
| [CPP-028. Can you add things to namespace `std`?](#question-cpp-028) | [CPP-029. `constexpr` vs `consteval` vs `constinit`?](#question-cpp-029) | [CPP-030. How do lambda captures work, and what can dangle?](#question-cpp-030) |
| [CPP-031. What is a lambda, really?](#question-cpp-031) | [CPP-032. How does `std::function` work, and why can it allocate?](#question-cpp-032) | [CPP-033. How do template instantiation and specialization work?](#question-cpp-033) |
| [CPP-034. What are variadic templates and fold expressions?](#question-cpp-034) | [CPP-035. SFINAE vs concepts and `requires`?](#question-cpp-035) | [CPP-036. What are type traits, and how does `if constexpr` change template code?](#question-cpp-036) |
| [CPP-037. What is CTAD, and when do you need a deduction guide?](#question-cpp-037) | [CPP-038. What are the rules for operator overloading, and what does `<=>` change?](#question-cpp-038) | [CPP-039. Which C++20/C++23 features are most relevant in production?](#question-cpp-039) |
| [CPP-040. What is a C++20 coroutine, at the level you would be asked about it?](#question-cpp-040) |  |  |

## Object Model, OOP, Lifetime and Exceptions

|  |  |  |
|---|---|---|
| [CPP-041. What are the principles of OOP, and what does each one actually buy you?](#question-cpp-041) | [CPP-042. IS-A vs HAS-A - how do you decide?](#question-cpp-042) | [CPP-043. Why prefer composition over inheritance?](#question-cpp-043) |
| [CPP-044. What kinds of polymorphism does C++ have?](#question-cpp-044) | [CPP-045. Abstract class, pure virtual function - how do you model an interface in C++?](#question-cpp-045) | [CPP-046. Why does a base class often need a virtual destructor?](#question-cpp-046) |
| [CPP-047. How do virtual functions usually work?](#question-cpp-047) | [CPP-048. Is there a vtable per object?](#question-cpp-048) | [CPP-049. What happens when calling a virtual function from a constructor or destructor?](#question-cpp-049) |
| [CPP-050. What is a pure virtual call, and how do you get one?](#question-cpp-050) | [CPP-051. What is object slicing?](#question-cpp-051) | [CPP-052. Overloading vs overriding?](#question-cpp-052) |
| [CPP-053. What is virtual inheritance?](#question-cpp-053) | [CPP-054. What determines the size of a C++ class?](#question-cpp-054) | [CPP-055. What does `dynamic_cast` cost, and when should you use it?](#question-cpp-055) |
| [CPP-056. `new` vs `malloc`?](#question-cpp-056) | [CPP-057. `delete` vs `delete[]`?](#question-cpp-057) | [CPP-058. What is placement new?](#question-cpp-058) |
| [CPP-059. What happens when a constructor throws?](#question-cpp-059) | [CPP-060. What happens when a destructor throws?](#question-cpp-060) | [CPP-061. What is `std::terminate`?](#question-cpp-061) |
| [CPP-062. What is stack unwinding?](#question-cpp-062) | [CPP-063. Strong exception guarantee?](#question-cpp-063) | [CPP-064. What is copy-and-swap?](#question-cpp-064) |

## RAII, Ownership and Smart Pointers

|  |  |  |
|---|---|---|
| [CPP-065. What is RAII?](#question-cpp-065) | [CPP-066. What are the Rule of Zero, Three, Five, and the so-called Seven/Ten variants?](#question-cpp-066) | [CPP-067. How does `std::unique_ptr` work?](#question-cpp-067) |
| [CPP-068. How should `unique_ptr` be passed to a function?](#question-cpp-068) | [CPP-069. Implement `unique_ptr`.](#question-cpp-069) | [CPP-070. How does `shared_ptr` work?](#question-cpp-070) |
| [CPP-071. Implement `shared_ptr` - what does the control block hold?](#question-cpp-071) | [CPP-072. What is the difference between `make_shared<T>()` and `shared_ptr<T>(new T)`?](#question-cpp-072) | [CPP-073. Why is constructing two `shared_ptr`s from the same raw pointer dangerous?](#question-cpp-073) |
| [CPP-074. Why are cyclic `shared_ptr` references a problem?](#question-cpp-074) | [CPP-075. What does `weak_ptr::lock()` do?](#question-cpp-075) | [CPP-076. What is `enable_shared_from_this`?](#question-cpp-076) |
| [CPP-077. What happens to the strong and weak counts when `shared_from_this()` is called?](#question-cpp-077) | [CPP-078. Is `shared_ptr` thread-safe?](#question-cpp-078) |  |

## STL Containers, Views and Vocabulary Types

|  |  |  |
|---|---|---|
| [CPP-079. How does `std::vector` work?](#question-cpp-079) | [CPP-080. What is the difference between `size()` and `capacity()`?](#question-cpp-080) | [CPP-081. `reserve()` vs `resize()`?](#question-cpp-081) |
| [CPP-082. When are vector iterators invalidated?](#question-cpp-082) | [CPP-083. Why is `push_back` amortized O(1)?](#question-cpp-083) | [CPP-084. Why is `vector` often faster than `list`?](#question-cpp-084) |
| [CPP-085. How do you choose between `vector`, `deque`, `list` and `forward_list`?](#question-cpp-085) | [CPP-086. `push_back` vs `emplace_back`?](#question-cpp-086) | [CPP-087. Why is `std::vector<bool>` not a container of `bool`?](#question-cpp-087) |
| [CPP-088. How does `std::string` store its data, and what is SSO?](#question-cpp-088) | [CPP-089. What is `std::string_view`?](#question-cpp-089) | [CPP-090. What is `std::span`?](#question-cpp-090) |
| [CPP-091. `map` vs `unordered_map`?](#question-cpp-091) | [CPP-092. Why can `unordered_map` become O(n)?](#question-cpp-092) | [CPP-093. What is rehashing?](#question-cpp-093) |
| [CPP-094. What contract must a hash function and equality predicate satisfy?](#question-cpp-094) | [CPP-095. What is strict weak ordering?](#question-cpp-095) | [CPP-096. How do `map`/`set` differ from their `multi` variants?](#question-cpp-096) |
| [CPP-097. What is `std::optional`, and when should it not be used?](#question-cpp-097) | [CPP-098. `std::variant` vs `std::any`?](#question-cpp-098) | [CPP-099. When should you use `pair`, `tuple` and structured bindings?](#question-cpp-099) |
| [CPP-100. How should `std::chrono` be used?](#question-cpp-100) |  |  |

## Algorithms, Iterators and Interview Patterns

|  |  |  |
|---|---|---|
| [CPP-101. What are iterator categories and why do they matter?](#question-cpp-101) | [CPP-102. Why prefer STL algorithms and ranges to handwritten loops?](#question-cpp-102) | [CPP-103. Will `std::sort` work on a `std::vector`? On a `std::list`?](#question-cpp-103) |
| [CPP-104. Which sort does the standard library give you, and when do you need `stable_sort`, `partial_sort` or `nth_element`?](#question-cpp-104) | [CPP-105. What are the erase-remove idiom and `std::erase_if`?](#question-cpp-105) | [CPP-106. `lower_bound` vs `upper_bound` vs `equal_range`?](#question-cpp-106) |
| [CPP-107. Why do containers have their own `find` when `std::find` exists?](#question-cpp-107) | [CPP-108. How does an LRU cache work?](#question-cpp-108) | [CPP-109. How does Floyd's tortoise-and-hare cycle detection work?](#question-cpp-109) |
| [CPP-110. How does Brent's cycle-detection algorithm differ from Floyd's?](#question-cpp-110) | [CPP-111. Two pointers vs sliding window?](#question-cpp-111) | [CPP-112. How do you write binary search with a correct invariant?](#question-cpp-112) |
| [CPP-113. BFS vs DFS?](#question-cpp-113) | [CPP-114. How does Dijkstra's shortest-path algorithm work?](#question-cpp-114) | [CPP-115. How does topological sorting work, and how does it detect a cycle?](#question-cpp-115) |
| [CPP-116. How does Union-Find / Disjoint Set Union work?](#question-cpp-116) | [CPP-117. How do heaps solve priority and top-K problems?](#question-cpp-117) | [CPP-118. How does Kadane's maximum-subarray algorithm work?](#question-cpp-118) |
| [CPP-119. How does Knuth-Morris-Pratt string search work?](#question-cpp-119) | [CPP-120. How do you merge overlapping intervals?](#question-cpp-120) | [CPP-121. What are prefix sums and difference arrays?](#question-cpp-121) |
| [CPP-122. What are monotonic stacks and queues used for?](#question-cpp-122) |  |  |

## Multithreading, Memory Model and Lock-Free Concurrency

|  |  |  |
|---|---|---|
| [CPP-123. What is a data race?](#question-cpp-123) | [CPP-124. Race condition vs data race?](#question-cpp-124) | [CPP-125. What does a mutex provide?](#question-cpp-125) |
| [CPP-126. `lock_guard` vs `unique_lock`?](#question-cpp-126) | [CPP-127. What is `scoped_lock`?](#question-cpp-127) | [CPP-128. What causes deadlock?](#question-cpp-128) |
| [CPP-129. Livelock and starvation vs deadlock?](#question-cpp-129) | [CPP-130. What is a condition variable?](#question-cpp-130) | [CPP-131. Why must condition variables use a predicate?](#question-cpp-131) |
| [CPP-132. How would you implement producer-consumer?](#question-cpp-132) | [CPP-133. How would you make a thread-safe queue?](#question-cpp-133) | [CPP-134. `std::thread`: `join`/`detach` vs `std::jthread`?](#question-cpp-134) |
| [CPP-135. How do `future`, `promise` and `async` work?](#question-cpp-135) | [CPP-136. When is `shared_mutex` useful?](#question-cpp-136) | [CPP-137. What is `std::atomic`?](#question-cpp-137) |
| [CPP-138. Atomic vs mutex?](#question-cpp-138) | [CPP-139. What is compare-and-swap?](#question-cpp-139) | [CPP-140. `compare_exchange_weak` vs `strong`?](#question-cpp-140) |
| [CPP-141. What is `memory_order_relaxed`?](#question-cpp-141) | [CPP-142. What are acquire and release semantics?](#question-cpp-142) | [CPP-143. What is happens-before?](#question-cpp-143) |
| [CPP-144. What is sequential consistency?](#question-cpp-144) | [CPP-145. What is false sharing?](#question-cpp-145) | [CPP-146. What does lock-free actually mean?](#question-cpp-146) |
| [CPP-147. How would you build a single-producer single-consumer queue without locks?](#question-cpp-147) | [CPP-148. What are the ABA and reclamation problems?](#question-cpp-148) |  |

## Performance and Scalability

|  |  |  |
|---|---|---|
| [CPP-149. How do you investigate a performance problem?](#question-cpp-149) | [CPP-150. Latency vs throughput?](#question-cpp-150) | [CPP-151. What are P50, P95 and P99?](#question-cpp-151) |
| [CPP-152. What is batching?](#question-cpp-152) | [CPP-153. What is coalescing?](#question-cpp-153) | [CPP-154. What is throttling?](#question-cpp-154) |
| [CPP-155. What is backpressure?](#question-cpp-155) | [CPP-156. Why can allocation be expensive?](#question-cpp-156) | [CPP-157. How do you reduce allocation overhead?](#question-cpp-157) |

## Build Model, Linkage, ABI and Native Libraries

|  |  |  |
|---|---|---|
| [CPP-158. What is a translation unit, and how does C++ source become an executable?](#question-cpp-158) | [CPP-159. What belongs in a header, and include guards vs `#pragma once`?](#question-cpp-159) | [CPP-160. Forward declaration vs `#include`?](#question-cpp-160) |
| [CPP-161. How do C/C++ macros work, and what are the common traps?](#question-cpp-161) | [CPP-162. Declaration vs definition?](#question-cpp-162) | [CPP-163. What are internal, external and no linkage?](#question-cpp-163) |
| [CPP-164. What is ODR?](#question-cpp-164) | [CPP-165. What does `inline` really mean?](#question-cpp-165) | [CPP-166. What is the static initialization order fiasco, and what fixes it?](#question-cpp-166) |
| [CPP-167. What is ABI?](#question-cpp-167) | [CPP-168. What is name mangling?](#question-cpp-168) | [CPP-169. Static vs dynamic library?](#question-cpp-169) |
| [CPP-170. What are `LoadLibrary` and `GetProcAddress`?](#question-cpp-170) | [CPP-171. Why is `DllMain` dangerous for complex work?](#question-cpp-171) | [CPP-172. How do PImpl, header-only and compiled libraries trade off?](#question-cpp-172) |
| [CPP-173. How do you evolve an API without breaking source or binary compatibility?](#question-cpp-173) |  |  |

## Debugging and Failure Analysis

|  |  |  |
|---|---|---|
| [CPP-174. How would you debug a host-process crash caused by a native plug-in?](#question-cpp-174) | [CPP-175. How would you investigate a deadlock?](#question-cpp-175) | [CPP-176. How would you debug a bug that appears only after several hours?](#question-cpp-176) |

## Systems and Networking Foundations

|  |  |  |
|---|---|---|
| [CPP-177. Process vs thread, and what is a context switch?](#question-cpp-177) | [CPP-178. What are a call stack and a stack frame?](#question-cpp-178) | [CPP-179. How do virtual memory, page faults and the TLB relate?](#question-cpp-179) |
| [CPP-180. How do cache hierarchy, alignment and padding affect performance?](#question-cpp-180) | [CPP-181. What is endianness?](#question-cpp-181) | [CPP-182. System calls vs interrupts, CPU exceptions and OS signals?](#question-cpp-182) |
| [CPP-183. What IPC mechanisms would you choose between?](#question-cpp-183) | [CPP-184. TCP vs UDP, and why does TCP need message framing?](#question-cpp-184) | [CPP-185. What is the socket lifecycle, and how do I/O multiplexers help?](#question-cpp-185) |
| [CPP-186. HTTP vs HTTPS vs WebSocket?](#question-cpp-186) |  |  |

## Software Design and APIs

|  |  |  |
|---|---|---|
| [CPP-187. What do the SOLID principles mean in practice?](#question-cpp-187) | [CPP-188. How do DRY, KISS and YAGNI complement each other?](#question-cpp-188) | [CPP-189. How do common GoF patterns differ?](#question-cpp-189) |
| [CPP-190. Observer vs pub-sub and event-driven architecture?](#question-cpp-190) | [CPP-191. Exceptions vs error codes vs `std::expected`?](#question-cpp-191) | [CPP-192. What does ACID mean?](#question-cpp-192) |

## UI Architecture

|  |  |  |
|---|---|---|
| [CPP-193. MVC, MVP and MVVM - what actually differs?](#question-cpp-193) | [CPP-194. What belongs in a view model, and what must not?](#question-cpp-194) | [CPP-195. How do you refactor a fat UI class into that shape without stopping delivery?](#question-cpp-195) |

# 1. Language Fundamentals and Modern C++

## Question CPP-001

[↑ Back to question index](#question-index)

### Question CPP-001 — What should you know about fundamental types, `nullptr` and `std::byte`?
...
### Question CPP-002 — What are integer promotions and usual arithmetic conversions?
...
### Question CPP-003 — What goes wrong when signed and unsigned meet in a comparison or a loop?
...
### Question CPP-004 — `enum` vs `enum class`?
...
### Question CPP-005 — How does `const` work with pointers and member functions?
...
### Question CPP-006 — What does `const` on a member function actually guarantee?
...
`std::propagate_const` exists as a wrapper for when you want the constness to reach through a pointer member, most usefully with PImpl ([CPP-172](#question-cpp-172)), where otherwise a `const` method can modify the entire implementation object.
...
### Question CPP-007 — When should each C++ cast be used?
...
### Question CPP-008 — What initialization forms exist, and why use braces carefully?
...
### Question CPP-009 — What is `explicit` used for?
...
### Question CPP-010 — What do `= default` and `= delete` mean?
...
### Question CPP-011 — What is the difference between `auto` and `decltype(auto)`?
...
### Question CPP-012 — What is `decltype`?
...
### Question CPP-013 — What is the difference between lvalue and rvalue?
...
### Question CPP-014 — What are prvalue, xvalue and glvalue?
...
### Question CPP-015 — Why can `const T&` bind to a temporary?
...
### Question CPP-016 — When does lifetime extension not work?
...
### Question CPP-017 — What does `std::move` actually do?
...
### Question CPP-018 — What is a forwarding reference?
...
### Question CPP-019 — What is `std::forward` used for?
...
### Question CPP-020 — Why should move constructors often be `noexcept`?
...
### Question CPP-021 — When does the compiler generate a move constructor?
...
### Question CPP-022 — What is copy elision?
...
### Question CPP-023 — In what order are function arguments evaluated, and why did that leak before C++17?
...
### Question CPP-024 — What is undefined behavior?
...
### Question CPP-025 — Undefined vs unspecified vs implementation-defined behavior?
...
### Question CPP-026 — What is the as-if rule?
...
Concretely, the compiler may delete a local you never read, keep a value in a register instead of memory, reorder two independent stores and replace a loop with a constant. The language also grants specific permissions beyond the general as-if rule: copy/move elision may omit constructor calls even when they have side effects, and allocation elision may omit calls to replaceable allocation functions. Since C++17 some apparent copy-elision cases are defined as direct construction rather than an optional optimisation.
...
- **`volatile` is the opt-out for a single object**: every access must actually happen and may not be reordered relative to other volatile accesses. It says nothing about atomicity or about ordering against non-volatile memory, which is why it is not a threading tool ([CPP-027](#question-cpp-027)).
...
### Question CPP-027 — What is `volatile` for?
...
### Question CPP-028 — Can you add things to namespace `std`?
...
### Question CPP-029 — `constexpr` vs `consteval` vs `constinit`?
...
### Question CPP-030 — How do lambda captures work, and what can dangle?
...
### Question CPP-031 — What is a lambda, really?
...
### Question CPP-032 — How does `std::function` work, and why can it allocate?
...
### Question CPP-033 — How do template instantiation and specialization work?
...
### Question CPP-034 — What are variadic templates and fold expressions?
...
### Question CPP-035 — SFINAE vs concepts and `requires`?
...
### Question CPP-036 — What are type traits, and how does `if constexpr` change template code?
...
Two practical notes. `if constexpr` only discards inside a template - in a non-template function both branches must compile. And a trait is a query, not a guarantee of behaviour: `std::is_nothrow_move_constructible_v` tells you what was declared, which is why declaring `noexcept` wrongly is worse than not declaring it ([CPP-063](#question-cpp-063)).
...
### Question CPP-037 — What is CTAD, and when do you need a deduction guide?
...
### Question CPP-038 — What are the rules for operator overloading, and what does `<=>` change?
...
### Question CPP-039 — Which C++20/C++23 features are most relevant in production?
...
### Question CPP-040 — What is a C++20 coroutine, at the level you would be asked about it?
...
# 2. Object Model, OOP, Lifetime and Exceptions

## Question CPP-041

[↑ Back to question index](#question-index)

### Question CPP-041 — What are the principles of OOP, and what does each one actually buy you?
...
The honest part of this answer is inheritance. It couples the derived class to the base's implementation, so a change to the base can break a derived class nobody remembered existed - the fragile base class problem. Prefer composition ([CPP-043](#question-cpp-043)), and use public inheritance only where the substitution in [CPP-042](#question-cpp-042) genuinely holds.
...
### Question CPP-042 — IS-A vs HAS-A - how do you decide?
...
### Question CPP-043 — Why prefer composition over inheritance?
...
### Question CPP-044 — What kinds of polymorphism does C++ have?
...
### Question CPP-045 — Abstract class, pure virtual function - how do you model an interface in C++?
...
Worth naming the limit too: C++ does not enforce that an interface has no state, and it allows multiple inheritance of interfaces without the diamond problem only because they carry no data ([CPP-053](#question-cpp-053) is where that stops being true).
...
### Question CPP-046 — Why does a base class often need a virtual destructor?
...
### Question CPP-047 — How do virtual functions usually work?
...
### Question CPP-048 — Is there a vtable per object?
...
- The `vptr` is set as each constructor runs, base first, which is exactly why dispatch during construction reaches the base override and not the derived one ([CPP-049](#question-cpp-049)).
...
### Question CPP-049 — What happens when calling a virtual function from a constructor or destructor?
...
### Question CPP-050 — What is a pure virtual call, and how do you get one?
...
- It happens because dispatch is restricted to the class currently being constructed or destroyed ([CPP-049](#question-cpp-049)) - and in the base, that function has no implementation at all, so there is nothing to dispatch to.
...
The fixes, in order of preference: do not call virtuals from constructors or destructors at all; use a two-step creation where a factory constructs the object and then calls `initialise()`; or pass the varying behaviour in as a parameter instead of inheriting it. If a virtual really must be called at construction time, that is a signal the design wants composition rather than inheritance ([CPP-042](#question-cpp-042)).

A pure virtual function may have a definition, which is occasionally used to give a default implementation ([CPP-045](#question-cpp-045)) - but that definition still does not make it callable through dispatch from a base constructor.
...
### Question CPP-051 — What is object slicing?
...
### Question CPP-052 — Overloading vs overriding?
...
### Question CPP-053 — What is virtual inheritance?
...
### Question CPP-054 — What determines the size of a C++ class?
...
### Question CPP-055 — What does `dynamic_cast` cost, and when should you use it?
...
The usual alternatives, in order of preference: a virtual function that does the thing; a `std::variant` with `std::visit` when the set of types is closed ([CPP-044](#question-cpp-044)); and an explicit type tag only when neither fits.
...
### Question CPP-056 — `new` vs `malloc`?
...
### Question CPP-057 — `delete` vs `delete[]`?
...
Worth knowing for completeness: `new` throws `std::bad_alloc` on failure while `new (std::nothrow)` returns null, and the matching `operator delete` is chosen at compile time from the static type - so deleting a derived object through a base pointer without a virtual destructor is a third variant of the same class of bug ([CPP-046](#question-cpp-046)).
...
### Question CPP-058 — What is placement new?
...
std::destroy_at(p);             // destroy, but do not delete
```

Calling `delete` on that pointer is undefined behaviour because no matching ordinary `new` expression allocated the storage. For a non-trivially destructible `T`, destroy the object before its resources or invariants require cleanup; destruction may be omitted for a trivially destructible type. Either way it does not release `buf`—the storage remains the responsibility of whoever supplied it and must eventually be reclaimed through its original mechanism.

The requirement people miss is **alignment**: the buffer must be suitably aligned for `T`, which is what `alignas` above guarantees. A plain `char` or `std::byte` array does not guarantee that alignment. Constructing at an insufficiently aligned address is undefined behaviour in C++, even if the processor often tolerates unaligned accesses.

If construction throws, the `T` object's lifetime never begins; already constructed subobjects are destroyed automatically and the caller still owns the raw storage. Pools and containers must similarly track exactly which elements completed construction so their failure cleanup destroys only those elements.

Where it is actually used: inside containers, so `vector` can have capacity without constructed elements ([CPP-081](#question-cpp-081)); inside `std::optional` and `std::variant`, which hold storage and construct into it on demand; in memory pools and arenas; and in embedded code that must place an object at a fixed hardware address.

Worth knowing that `std::construct_at` (C++20) and `std::destroy_at` are the modern generic spellings. When storage is reused for another object, keep the pointer returned by construction; old pointers do not automatically name the replacement in every lifetime-sensitive case, which is where `std::launder` may be required.
...
### Question CPP-059 — What happens when a constructor throws?
...
### Question CPP-060 — What happens when a destructor throws?
...
The connection to the rest: this is why `swap` and move operations are expected to be `noexcept` ([CPP-063](#question-cpp-063)) - the commit step of the strong guarantee has to be a step that cannot fail, and the same reasoning makes destructors non-throwing by construction.
...
### Question CPP-061 — What is `std::terminate`?
...
### Question CPP-062 — What is stack unwinding?
...
Only objects whose construction **completed** are destroyed - which is the same rule that decides what happens when a constructor throws ([CPP-059](#question-cpp-059)). A partially constructed object has no destructor call, so anything it acquired raw is lost.
...
- `std::terminate` - an exception escaping `noexcept`, or one thrown during unwinding ([CPP-061](#question-cpp-061)) - aborts without unwinding the remaining frames.
...
### Question CPP-063 — Strong exception guarantee?
...
This is also why move constructors should be `noexcept` ([CPP-020](#question-cpp-020)): `vector` reallocation must keep the strong guarantee, so if moving elements could throw it copies them instead. One missing `noexcept` silently turns every reallocation from moves into copies, and nothing reports it.

The practical decision: aim for the basic guarantee everywhere as a baseline, the strong guarantee where a caller would otherwise have to clean up after a failure, and `noexcept` where the standard requires it or where failure genuinely cannot happen. Promising `noexcept` and then throwing is worse than promising nothing - it calls `std::terminate` ([CPP-061](#question-cpp-061)).
...
### Question CPP-064 — What is copy-and-swap?
...
### Question CPP-066 — What are the Rule of Zero, Three, Five, and the so-called Seven/Ten variants?
...
### Question CPP-067 — How does `std::unique_ptr` work?
...
### Question CPP-068 — How should `unique_ptr` be passed to a function?
...
### Question CPP-069 — Implement `unique_ptr`.
...
### Question CPP-070 — How does `shared_ptr` work?
...
### Question CPP-071 — Implement `shared_ptr` - what does the control block hold?
...
The follow-ups this invites are all already answerable: why `make_shared` versus `shared_ptr(new T)` ([CPP-072](#question-cpp-072), [CPP-023](#question-cpp-023)), cycles and `weak_ptr` ([CPP-074](#question-cpp-074)), the counter effect of `shared_from_this()` ([CPP-077](#question-cpp-077)), and what "thread-safe" does and does not mean here ([CPP-078](#question-cpp-078)).
...
### Question CPP-072 — What is the difference between `make_shared<T>()` and `shared_ptr<T>(new T)`?
...
### Question CPP-073 — Why is constructing two `shared_ptr`s from the same raw pointer dangerous?
...
### Question CPP-074 — Why are cyclic `shared_ptr` references a problem?
...
### Question CPP-075 — What does `weak_ptr::lock()` do?
...
The returned `shared_ptr` keeps the object alive for as long as you hold it, which is exactly what makes the pattern safe in a callback: the observer stores a `weak_ptr`, locks it when the event arrives, and does nothing if the subject has gone. That is the standard answer to the dangling-callback problem ([CPP-074](#question-cpp-074)).
...
### Question CPP-076 — What is `enable_shared_from_this`?
...
The internal `weak_ptr` and the exact strong/weak counter changes are covered in [CPP-077](#question-cpp-077).
...
### Question CPP-077 — What happens to the strong and weak counts when `shared_from_this()` is called?

**Short answer**

- `enable_shared_from_this<A>` contains an exposition-only internal `weak_ptr`; the first compatible `shared_ptr` that owns the object binds it to the same control block.
- After `p1 = make_shared<A>()` there is logically one strong owner and one internal weak observer. `p1->shared_from_this()` promotes that existing weak observer into `p2`, so the strong-owner count becomes two while the number of `weak_ptr` objects stays one.
- The standard specifies this behavior, not the raw control-block layout. libstdc++ and MSVC STL commonly show raw counts `1/2` then `2/2`; current libc++ uses offset counters that commonly show `0/1` then `1/1`.

**Details and nuances**

The class must inherit publicly and unambiguously from the matching specialization:
...
When `p1` is created, the `shared_ptr` constructor detects that base and binds its internal `weak_ptr`—often described as `weak_this`—to the new control block. `shared_from_this()` then constructs a `shared_ptr` from that already existing weak reference; it does not create another `weak_ptr` or another control block:
...
p1 -------->| strong owners  |
p2 -------->|       2        |----> A
weak_this ->| weak observers |
            |       1        |
            +----------------+
```

The portable logical model is:

| Statement | Strong owners | `weak_ptr` objects |
|---|---:|---:|
| `auto p1 = std::make_shared<A>();` | 1 (`p1`) | 1 (`weak_this`) |
| `auto p2 = p1->shared_from_this();` | 2 (`p1`, `p2`) | 1 (`weak_this`) |
| `auto w = p1->weak_from_this();` | 2 | 2 (`weak_this`, `w`) |

So the interview answer is: **`shared_from_this()` adds one strong owner, not one weak observer**. Calling it before the object has been attached to a compatible control block—most notably from its constructor—throws `std::bad_weak_ptr`. `weak_from_this()` (C++17) is the non-owning alternative and returns an empty weak pointer when no binding exists.

Debugger fields need a separate, implementation-specific explanation. For this exact example and no other weak pointers, representative current implementations encode the same logical state as follows:

| Standard library | After `p1`: raw strong/weak | After `p2`: raw strong/weak | Why |
|---|---:|---:|---|
| libstdc++ | `_M_use_count = 1`, `_M_weak_count = 2` | `2`, `2` | `_M_weak_count` includes `weak_this` plus a control-block hold while strong owners exist. |
| MSVC STL | `_Uses = 1`, `_Weaks = 2` | `2`, `2` | `_Weaks` uses the same extra control-block hold; the debugger displays live weak observers as `_Weaks - 1`. |
| libc++ | `__shared_owners_ = 0`, `__shared_weak_owners_ = 1` | `1`, `1` | Both internal owner counters use an offset representation; `use_count()` returns `__shared_owners_ + 1`. |

Those field names and raw values are not an ABI or source-level guarantee. The portable observer is `shared_ptr::use_count()`, which returns `1` and then `2` here. There is no standard API that reports the number of `weak_ptr` objects; `weak_ptr::use_count()` also reports the **strong** owner count.

Finally, this depends on the **standard-library implementation**, not primarily on the compiler front end. Clang commonly uses libstdc++ on Linux and will then look like GCC; only Clang configured with libc++ uses libc++'s representation.

Representative implementation sources: [libstdc++ control-block counters](https://gcc.gnu.org/onlinedocs/libstdc++/latest-doxygen/a00695_source.html), [MSVC STL reference-count base](https://github.com/microsoft/STL/blob/main/stl/inc/memory) and [debugger interpretation](https://github.com/microsoft/STL/blob/main/stl/debugger/STL.natvis), and libc++ [counter representation](https://github.com/llvm/llvm-project/blob/main/libcxx/include/__memory/shared_count.h) and [`enable_shared_from_this` hookup](https://github.com/llvm/llvm-project/blob/main/libcxx/include/__memory/shared_ptr.h).
...
### Question CPP-078 — Is `shared_ptr` thread-safe?
...
# 4. STL Containers, Views and Vocabulary Types

## Question CPP-079

[↑ Back to question index](#question-index)

### Question CPP-079 — How does `std::vector` work?
...
### Question CPP-080 — What is the difference between `size()` and `capacity()`?
...
The gap between them is raw storage: allocated, uninitialised, and not yet holding objects. That is why `v[i]` for `i >= size()` is undefined behaviour even when `i < capacity()` ([CPP-081](#question-cpp-081)).

Growth is geometric - typically 1.5x or 2x depending on the implementation - which is what makes `push_back` amortised O(1) ([CPP-083](#question-cpp-083)). The two factors trade differently: 2x is simpler, 1.5x can reuse previously freed blocks, and neither is mandated by the standard.
...
### Question CPP-081 — `reserve()` vs `resize()`?
...
**Both can reallocate, and reallocation invalidates everything** - all iterators, pointers and references into the vector. That is the reason to `reserve` before a loop that takes addresses of elements, and the reason a saved iterator across a `push_back` is a bug ([CPP-082](#question-cpp-082)).

Two more that tend to be the follow-up:

- Whether reallocation *moves* or *copies* the existing elements depends on `T`'s move constructor being `noexcept`, because `vector` must preserve the strong exception guarantee ([CPP-020](#question-cpp-020), [CPP-063](#question-cpp-063)).
...
### Question CPP-082 — When are vector iterators invalidated?
...
### Question CPP-083 — Why is `push_back` amortized O(1)?
...
### Question CPP-084 — Why is `vector` often faster than `list`?
...
### Question CPP-085 — How do you choose between `vector`, `deque`, `list` and `forward_list`?
...
### Question CPP-086 — `push_back` vs `emplace_back`?
...
### Question CPP-087 — Why is `std::vector<bool>` not a container of `bool`?
...
### Question CPP-088 — How does `std::string` store its data, and what is SSO?
...
Related and frequently asked next: `std::string_view` ([CPP-089](#question-cpp-089)) avoids both the allocation and the copy, at the price of not owning anything - so returning a `string_view` to a temporary is a dangling reference, and that is the follow-up question.
...
### Question CPP-089 — What is `std::string_view`?
...
### Question CPP-090 — What is `std::span`?
...
It is the array analogue of `string_view` ([CPP-089](#question-cpp-089)): a pointer and a length, no ownership, no allocation, and it binds to a C array, a `std::array`, a `std::vector` or any contiguous range.
...
### Question CPP-091 — `map` vs `unordered_map`?
...
### Question CPP-092 — Why can `unordered_map` become O(n)?
...
**Rehashing** is the second cost: when `size() / bucket_count()` exceeds `max_load_factor()`, the container rebuilds with more buckets and rehashes everything - O(n), and it invalidates all iterators ([CPP-093](#question-cpp-093)). `reserve()` up front avoids the repeated rebuilds.

Worth mentioning as the practical counterweight: for small collections `std::map` or even a sorted `std::vector` often beats `unordered_map` outright, because the tree or the linear scan is cache-friendly and the hash container chases pointers ([CPP-091](#question-cpp-091)).
...
### Question CPP-093 — What is rehashing?
...
### Question CPP-094 — What contract must a hash function and equality predicate satisfy?
...
### Question CPP-095 — What is strict weak ordering?
...
### Question CPP-096 — How do `map`/`set` differ from their `multi` variants?
...
### Question CPP-097 — What is `std::optional`, and when should it not be used?
...
### Question CPP-098 — `std::variant` vs `std::any`?
...
### Question CPP-099 — When should you use `pair`, `tuple` and structured bindings?
...
### Question CPP-100 — How should `std::chrono` be used?
...
# 5. Algorithms, Iterators and Interview Patterns

## Question CPP-101

[↑ Back to question index](#question-index)

### Question CPP-101 — What are iterator categories and why do they matter?
...
### Question CPP-102 — Why prefer STL algorithms and ranges to handwritten loops?
...
### Question CPP-103 — Will `std::sort` work on a `std::vector`? On a `std::list`?
...
`list::sort` being a member is the general pattern for node-based containers: `list` also has member `remove`, `unique`, `reverse` and `merge`, and they exist because the member version relinks nodes in `O(1)` each where the generic algorithm would copy values. Same for `map::find`, which is `O(log n)` against `std::find`'s `O(n)` ([CPP-107](#question-cpp-107)).

The everyday practical answer: this is one more reason `vector` is the default container ([CPP-084](#question-cpp-084)). Choosing `list` costs you most of `<algorithm>`.
...
### Question CPP-104 — Which sort does the standard library give you, and when do you need `stable_sort`, `partial_sort` or `nth_element`?
...
### Question CPP-105 — What are the erase-remove idiom and `std::erase_if`?
...
### Question CPP-106 — `lower_bound` vs `upper_bound` vs `equal_range`?
...
### Question CPP-107 — Why do containers have their own `find` when `std::find` exists?
...
A related pairing worth knowing: the erase-remove idiom ([CPP-105](#question-cpp-105)) is for sequence containers, because `std::remove` cannot erase - it only shuffles. For `list` the member `remove` does erase, and for associative containers `erase(key)` does it directly. C++20's `std::erase` and `std::erase_if` free functions finally give one spelling that does the right thing for each container.
...
### Question CPP-108 — How does an LRU cache work?
...
### Question CPP-109 — How does Floyd's tortoise-and-hare cycle detection work?
...
### Question CPP-110 — How does Brent's cycle-detection algorithm differ from Floyd's?
...
### Question CPP-111 — Two pointers vs sliding window?
...
### Question CPP-112 — How do you write binary search with a correct invariant?
...
### Question CPP-114 — How does Dijkstra's shortest-path algorithm work?
...
### Question CPP-115 — How does topological sorting work, and how does it detect a cycle?
...
### Question CPP-116 — How does Union-Find / Disjoint Set Union work?
...
### Question CPP-117 — How do heaps solve priority and top-K problems?
...
### Question CPP-118 — How does Kadane's maximum-subarray algorithm work?
...
### Question CPP-119 — How does Knuth-Morris-Pratt string search work?
...
### Question CPP-120 — How do you merge overlapping intervals?
...
### Question CPP-121 — What are prefix sums and difference arrays?
...
### Question CPP-122 — What are monotonic stacks and queues used for?
...
# 6. Multithreading, Memory Model and Lock-Free Concurrency

## Question CPP-123

[↑ Back to question index](#question-index)

### Question CPP-123 — What is a data race?
...
### Question CPP-124 — Race condition vs data race?
...
### Question CPP-125 — What does a mutex provide?
...
### Question CPP-126 — `lock_guard` vs `unique_lock`?
...
### Question CPP-127 — What is `scoped_lock`?
...
Since C++17 `scoped_lock` is the default choice over `lock_guard`: it does the same job for one mutex and the right thing for several. The one trap is CTAD-related - `std::scoped_lock lock(m);` is correct and `std::scoped_lock(m);` creates a temporary that unlocks immediately ([CPP-037](#question-cpp-037)).
...
### Question CPP-128 — What causes deadlock?
...
### Question CPP-129 — Livelock and starvation vs deadlock?
...
### Question CPP-130 — What is a condition variable?
...
### Question CPP-131 — Why must condition variables use a predicate?
...
### Question CPP-132 — How would you implement producer-consumer?
...
### Question CPP-133 — How would you make a thread-safe queue?
...
### Question CPP-134 — `std::thread`: `join`/`detach` vs `std::jthread`?
...
### Question CPP-135 — How do `future`, `promise` and `async` work?
...
### Question CPP-136 — When is `shared_mutex` useful?
...
### Question CPP-137 — What is `std::atomic`?
...
### Question CPP-138 — Atomic vs mutex?
...
**Every write invalidates the line everywhere.** That is the same mechanism as false sharing ([CPP-145](#question-cpp-145)) but with the variable genuinely shared, so padding does not help. The fix is usually to stop sharing the variable - per-thread counters summed at the end, or batching - rather than to make the shared write cheaper.
...
### Question CPP-139 — What is compare-and-swap?
...
### Question CPP-140 — `compare_exchange_weak` vs `strong`?
...
### Question CPP-141 — What is `memory_order_relaxed`?
...
- A reference count **increment**, because adding a reference cannot let anything die. The decrement must be stronger - `acq_rel` - so the thread that reaches zero sees every other thread's writes before running the destructor ([CPP-071](#question-cpp-071)).
...
### Question CPP-142 — What are acquire and release semantics?
...
### Question CPP-143 — What is happens-before?
...
### Question CPP-144 — What is sequential consistency?
...
### Question CPP-145 — What is false sharing?
...
### Question CPP-146 — What does lock-free actually mean?
...
- Lock-free does not mean faster, and it does not mean no atomic instructions - it means no lock, and the failure mode changes from blocking to retrying ([CPP-138](#question-cpp-138)).
...
### Question CPP-147 — How would you build a single-producer single-consumer queue without locks?
...
- Pad the two indices onto separate cache lines, or the two threads fight over one line and the queue is slower than a mutex ([CPP-145](#question-cpp-145)).
...
Why it stops being simple the moment you add a second producer: two producers both reading `head_`, both writing a slot, both storing `head_ + 1` - now you need a CAS loop, and with a CAS loop come retries, the ABA question and the reclamation question ([CPP-148](#question-cpp-148)). Multi-producer multi-consumer lock-free queues are a library, not an exercise; use one rather than writing one.
...
### Question CPP-148 — What are the ABA and reclamation problems?
...
Saying this out loud is the senior answer to "would you write a lock-free queue": for SPSC yes ([CPP-147](#question-cpp-147)), and beyond that the correct engineering decision is to use an existing implementation or a mutex, because the failure mode is silent corruption under load on one machine.
...
### Question CPP-149 — How do you investigate a performance problem?
...
### Question CPP-150 — Latency vs throughput?
...
### Question CPP-151 — What are P50, P95 and P99?
...
### Question CPP-152 — What is batching?
...
### Question CPP-153 — What is coalescing?
...
### Question CPP-154 — What is throttling?
...
### Question CPP-155 — What is backpressure?
...
### Question CPP-156 — Why can allocation be expensive?
...
- **Bookkeeping** - finding a suitable free block, splitting it and updating allocator metadata can cost far more than the arithmetic around the allocation.
- **Synchronisation** - shared allocator and OS paths can contend. Modern allocators reduce the common case with per-thread caches or arenas, but cache refills, large allocations and cross-thread frees can still interact; changing allocators is worth considering only after measurement.
...
- **Cache behaviour** - separately allocated nodes land anywhere, so traversing them is a chain of cache misses. This usually dominates the other three, and it is the real reason `vector` beats `list` ([CPP-084](#question-cpp-084)).
...
### Question CPP-157 — How do you reduce allocation overhead?
...
# 8. Build Model, Linkage, ABI and Native Libraries

## Question CPP-158

[↑ Back to question index](#question-index)

### Question CPP-158 — What is a translation unit, and how does C++ source become an executable?
...
### Question CPP-159 — What belongs in a header, and include guards vs `#pragma once`?
...
### Question CPP-160 — Forward declaration vs `#include`?
...
### Question CPP-161 — How do C/C++ macros work, and what are the common traps?
...
### Question CPP-162 — Declaration vs definition?
...
### Question CPP-163 — What are internal, external and no linkage?
...
### Question CPP-165 — What does `inline` really mean?
...
The keyword's job is linkage, not optimisation. It tells the linker that multiple identical definitions of this entity are expected and must be folded into one, instead of being a one-definition-rule violation ([CPP-164](#question-cpp-164)). That is why a function defined in a header needs it and a function defined in a `.cpp` does not.
...
- **`inline` variables** (C++17) apply the same rule to data, which is what finally allows a header-only library to define a global without the old trick of a function returning a static reference ([CPP-166](#question-cpp-166)).
...
### Question CPP-166 — What is the static initialization order fiasco, and what fixes it?
...
### Question CPP-168 — What is name mangling?
...
### Question CPP-169 — Static vs dynamic library?
...
### Question CPP-170 — What are `LoadLibrary` and `GetProcAddress`?
...
- **Name mangling**: a C++ function is exported under its decorated name, so `GetProcAddress` with the source name fails. Plugin entry points are declared `extern "C"` for exactly this reason ([CPP-168](#question-cpp-168)).
...
- **Do not do real work in `DllMain`** ([CPP-171](#question-cpp-171)): it runs under the loader lock, so calling `LoadLibrary` or waiting on anything from there deadlocks.
...
### Question CPP-171 — Why is `DllMain` dangerous for complex work?
...
### Question CPP-172 — How do PImpl, header-only and compiled libraries trade off?
...
### Question CPP-173 — How do you evolve an API without breaking source or binary compatibility?
...
### Question CPP-174 — How would you debug a host-process crash caused by a native plug-in?
...
### Question CPP-175 — How would you investigate a deadlock?
...
### Question CPP-176 — How would you debug a bug that appears only after several hours?
...
# 10. Systems and Networking Foundations

## Question CPP-177

[↑ Back to question index](#question-index)

### Question CPP-177 — Process vs thread, and what is a context switch?
...
### Question CPP-178 — What are a call stack and a stack frame?
...
### Question CPP-179 — How do virtual memory, page faults and the TLB relate?
...
### Question CPP-180 — How do cache hierarchy, alignment and padding affect performance?
...
Two threads writing different variables on one cache line can suffer false sharing ([CPP-145](#question-cpp-145)). Conversely, data read together should often live together; layout optimization must balance sharing, working-set size and maintainability.
...
### Question CPP-181 — What is endianness?
...
### Question CPP-182 — System calls vs interrupts, CPU exceptions and OS signals?
...
### Question CPP-183 — What IPC mechanisms would you choose between?
...
### Question CPP-184 — TCP vs UDP, and why does TCP need message framing?
...
### Question CPP-185 — What is the socket lifecycle, and how do I/O multiplexers help?
...
### Question CPP-186 — HTTP vs HTTPS vs WebSocket?
...
# 11. Software Design and APIs

## Question CPP-187

[↑ Back to question index](#question-index)

### Question CPP-187 — What do the SOLID principles mean in practice?
...
### Question CPP-188 — How do DRY, KISS and YAGNI complement each other?
...
### Question CPP-189 — How do common GoF patterns differ?
...
### Question CPP-190 — Observer vs pub-sub and event-driven architecture?
...
### Question CPP-191 — Exceptions vs error codes vs `std::expected`?
...
### Question CPP-192 — What does ACID mean?
...
### Question CPP-193 — MVC, MVP and MVVM - what actually differs?
...
### Question CPP-194 — What belongs in a view model, and what must not?
...
### Question CPP-195 — How do you refactor a fat UI class into that shape without stopping delivery?
