...
|---|---|
| What happens when `AddRef`/`Release` ownership is wrong, and how would RAII prevent it? | COM-004, with the `ComPtr` sketch; CPP-065 to CPP-078 for ownership generally |
