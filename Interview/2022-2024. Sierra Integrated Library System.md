...
**Scale.** The customer is a global research-technology provider serving more than 9,000 libraries worldwide. That figure is the reason compatibility dominated every decision here: a behavior change that suits one library becomes a support incident across thousands of institutions, each with its own workflows, integrations and decades of accumulated data.
...
Across the full EPAM period, covering both this project and the oil-and-gas system: 100+ defects fixed spanning C, C++, Java, JavaScript and Scala, and 20+ new features developed and integrated into existing architecture.
