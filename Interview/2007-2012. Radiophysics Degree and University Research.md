...
The Samara school is worth describing rather than listing. Samara has run it since 2003 with support from the International Astronautical Federation and the Volga branch of the Tsiolkovsky Russian Academy of Cosmonautics. Lectures are given **in English**, the lecturers are international, and the intake is international - students come from across Europe and beyond, selected by application. The programme covers nanosatellite design, CubeSat-class platforms and space experiments, with practical work assembling and launching an atmospheric probe. For me it was the first sustained technical work in English and the first time studying alongside engineers from other countries, five years before English became my working language at EPAM. I went back for a second session in August 2013, by then working at PELENG; that one belongs to the PELENG period and is recorded in `2012-2020. Satellite and UAV Optical Imaging Software.md`.
...
| Summer Space School, Samara State Aerospace University, August 2011 | Space-systems specialization outside the curriculum | `Certificates/2007-2012. Radiophysics Degree and University Research/2011 Advanced technologies for nanosatellite's experiments in space - 2011.pdf` |
...
- Attended the International Summer Space School at Samara State Aerospace University on advanced technologies for nanosatellite experiments in space (August 2011, 3.5 ECTS), taught in English to an international intake.
...
Each period in this set now has its own folder in `Articles/` and in `Certificates/`, named after the document that owns it. The three papers from the degree are below. The three sorbent and metal-ion papers that used to sit beside them are school-age work and now live in `Articles/1996-2007. School Years and Pre-University Research/`, covered by `1996-2007. School Years and Pre-University Research.md`.
...
- `2010 Transient Luminous Events in the Upper Atmosphere (coursework, RU).pdf` - "Transient Luminous Events in the Upper Atmosphere", 3rd year coursework, BSU Faculty of Radiophysics and Electronics, Department of Physics, Minsk 2010, 26 pages. Supervisor E. V. Verkhoturova.

**Other repository material**

- `Certificates/2007-2012. Radiophysics Degree and University Research/2011 Advanced technologies for nanosatellite's experiments in space - 2011.pdf` - the 2011 Summer Space School, Samara State Aerospace University. The second session, August 2013, belongs to the PELENG period and is covered there.
