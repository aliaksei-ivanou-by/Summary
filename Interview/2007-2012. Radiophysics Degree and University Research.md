...
The Samara school is worth describing rather than listing. Samara has run it since 2003 with support from the International Astronautical Federation and the Volga branch of the Tsiolkovsky Russian Academy of Cosmonautics. Lectures are given **in English**, the lecturers are international, and the intake is international - students come from across Europe and beyond, selected by application. The programme covers nanosatellite design, CubeSat-class platforms and space experiments, with practical work assembling and launching an atmospheric probe. For me it was the first sustained technical work in English and the first time studying alongside engineers from other countries, about ten years before English became my working language at EPAM. I went back for a second session in August 2013, by then working at PELENG; that one belongs to the PELENG period and is recorded in `2012-2020. Satellite and UAV Optical Imaging Software.md`.
