...
| Delivery company / customer | The Information Centre for Land Cadastre Data and Land Monitoring, a unitary enterprise (УП «Информационный центр земельно-кадастровых данных и мониторинга земель», ИЦЗем) - the organization operating the Land Information System of Belarus; then SKB Kamerton (ОАО «СКБ Камертон»), a manufacturer of satellite transport-monitoring equipment |
| Role | Engineer, Department of Navigation and Information Technologies (Land Cadastre Information Centre); software engineer, part-time (SKB Kamerton) |
...
The Information Centre for Land Cadastre Data and Land Monitoring - in Russian, Информационный центр земельно-кадастровых данных и мониторинга земель, abbreviated ИЦЗем - is the organization responsible for the Land Information System of Belarus: the national digital cadastral map and the automation of land-management activity, operated as a three-level structure across district, regional and national levels. Satellite navigation and transport monitoring sat naturally alongside that mandate, and were delivered by the Department of Navigation and Information Technologies, where I worked.
...
At SKB Kamerton the engagement was part-time, short and software-focused - maintaining an existing C# product alongside my main job at PELENG.
...
- **Land Information System (LIS, in Russian ЗИС):** the Belarusian national system for cadastral mapping and land-management automation, operated by the Land Cadastre Information Centre.
...
- Company register entry for the Land Cadastre Information Centre (УП, Minsk): [https://www.belarusinfo.by/ru/poisk/45581/filials.html](https://www.belarusinfo.by/ru/poisk/45581/filials.html)
...
| SKB Kamerton, part-time software engineer, Oct - Dec 2012; C#, MySQL, PostgreSQL | First-hand record | Public |
...
| SKB Kamerton founded 1990, became ОАО in 2012, over 100 specialists | [Wialon hardware catalogue](https://wialon.com/ru/hw-manufacturers/skb-kamerton) | Public |
| The Land Cadastre Information Centre is a unitary enterprise (УП) based in Minsk | [Belarusian company register](https://www.belarusinfo.by/ru/poisk/45581/filials.html) | Public |
